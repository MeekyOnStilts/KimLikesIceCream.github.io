    ...
    app.main.support = app.createElement(
        ...
        [
            app.createElement('section', [
                app.createElement('p', 'You are being taken to the a rick roll lol (https://www.youtube.com/watch?v=dQw4w9WgXcQ).', {
                        style: {
                            'margin-bottom': '0'
                        }
                    }),
                    app.createElement('p', 'Are you sure you want to <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">proceed</a>?', {
                        style: {
                            'margin-bottom': '0'
                        }
                    }),
